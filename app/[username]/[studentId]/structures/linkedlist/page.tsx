  ...
  const renderNodes = () => {
    ...
    return nodes.map((node, index) => (
      <div key={index} className="flex items-center space-x-4">
        <div className={`flex justify-center items-center p-4 border-4 rounded-lg min-w-[80px] min-h-[80px] text-center text-xl font-semibold shadow-lg text-black ${newNode === node.value ? "border-yellow-500 bg-yellow-200" : "border-green-500 bg-green-100"}`}>
