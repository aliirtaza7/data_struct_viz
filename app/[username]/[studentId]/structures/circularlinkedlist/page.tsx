...
export default function Page() {
  ...
  useEffect(() => {
    ...
    pathElement.setAttribute("strokeWidth", "3");
  ...
  const renderNodes = () => {
    ...
    return nodes.map((node, index) => (
      <div
        ...
        id={`${index}`}
      >
        <div className={`flex justify-center items-center border-4 rounded-lg min-w-[80px] min-h-[80px] text-center text-xl font-semibold shadow-lg relative text-black ${newNode === node.data ? "border-yellow-500 bg-yellow-200" : "border-green-500 bg-green-100"}`}>
